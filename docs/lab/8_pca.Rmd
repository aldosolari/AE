...
5. Calcolare la correlazione tra il voto centrato sullo 0 dell'esame in `Statistics` (quinta colonna della matrice $\tilde{X}$) e i punteggi della prima componente principale (prima colonna della matrice $Y$). Si ricordi la formula
...
6. Scegliere il numero $q$ di componenti principali utilizzando i 
