...
5. Si calcolino le statistiche test rapporto di verosimiglianza $T= n \log (|\hat{\Lambda} \hat{\Lambda}' + \hat{\Psi}|/|R|)$ e $T_{Bartlett}= ((n-1) - (2p+4k+5)/6) \log (|\hat{\Lambda} \hat{\Lambda}' + \hat{\Psi}|/|R|)$ e il corrispondente $p$-value. Infine, determinare $c$ per la regione critica $[c,+\infty)$ al livello $\alpha=5\%$.
